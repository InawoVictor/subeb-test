    ...
    <div>
        ...
        <div class="bg-whiteBg w-full" v-if="trainingData">
            <div class=" pt-8">
                ...
                <div class="sm:w-[90%] w-full sm:mx-auto mx-0 "><img :src="trainingData.blogCoverImage[0].Location" class="w-full h-[245px] sm:h-[570px] object-cover" alt=""></div>
...
const getSingleTraining = async () => {
    ...
    const data = await training.getSingleTraining(id);
    trainingData.value = data;
    // console.log("news data: " + trainingData.value);
}
